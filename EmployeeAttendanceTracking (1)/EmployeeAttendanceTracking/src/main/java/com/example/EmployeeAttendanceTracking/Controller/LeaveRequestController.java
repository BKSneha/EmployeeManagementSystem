...
public class LeaveRequestController
{
    ...
    @PutMapping("/approveLeaveRequest/approveLeaveRequest/{employeeId}")
    ...
    public ResponseEntity<Long> getLeaveRequestCountByEmployeeId(@PathVariable long employeeId) {
        long leaveRequestCount = leaveRequestService.getLeaveRequestCountByEmployeeId(employeeId);
        return ResponseEntity.ok(leaveRequestCount);
    }
}
